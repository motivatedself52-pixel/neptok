  ...
  return (
    <main className="min-h-screen bg-black text-white max-w-md mx-auto relative pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center bg-black border-t border-gray-800 py-2 text-[10px] text-white">
        <Link href="/" className="flex flex-col items-center gap-0.5 text-white font-bold">
          <span className="text-lg">🏠</span>
          <span>Home</span>
        </Link>
        <Link href="/explore" className="flex flex-col items-center gap-0.5 text-gray-400">
          <span className="text-lg">🧭</span>
          <span>Discover</span>
        </Link>
        ...
        <Link href="/wallet" className="flex flex-col items-center gap-0.5 text-gray-400 relative">
          <span className="text-lg">💬</span>
